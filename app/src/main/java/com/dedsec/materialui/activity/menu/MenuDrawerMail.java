...
public class MenuDrawerMail extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Drawer News");
        ...
        if (!is_account_mode) {
            ...
            switch (item.getItemId()) {
                ...
                case 2000:
                    ...
                    email.setText(item.getTitle().toString());
                    avatar.setImageResource(R.drawable.person3);
                    break;
                default:
    ...
    private void updateCounter(NavigationView nav) {
        ...
        badgeSocial.setBackgroundColor(getResources().getColor(R.color.pink_500));
