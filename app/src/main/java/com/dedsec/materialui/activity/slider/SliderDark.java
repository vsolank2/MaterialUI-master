package com.dedsec.materialui.activity.slider;
...
public class SliderDark extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        seekbar_primary_dark.getProgressDrawable().setColorFilter(getResources().getColor(R.color.blue_600), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        seekbar_primary_dark_outline.getProgressDrawable().setColorFilter(getResources().getColor(R.color.blue_600), android.graphics.PorterDuff.Mode.SRC_IN);
