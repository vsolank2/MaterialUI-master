...
import com.dedsec.materialui.content.ContentTabsStore;
...
public class TabsIcon extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        Tools.setSystemBarColor(this, R.color.red_500);
    }
    ...
    private void initComponent() {
        ...
        tab_layout.getTabAt(0).setIcon(R.drawable.ic_music_white);
        tab_layout.getTabAt(1).setIcon(R.drawable.ic_movie);
        tab_layout.getTabAt(2).setIcon(R.drawable.ic_book_white);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(ContentTabsStore.newInstance(), "Music");    // index 0
        viewPagerAdapter.addFragment(ContentTabsStore.newInstance(), "Movies");   // index 1
        viewPagerAdapter.addFragment(ContentTabsStore.newInstance(), "Books");    // index 2
        viewPagerAdapter.addFragment(ContentTabsStore.newInstance(), "Games");    // index 3
