...
public class TabsStore extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(ContentTabsStore.newInstance(), "MUSIC");
        adapter.addFragment(ContentTabsStore.newInstance(), "MOVIES");
        adapter.addFragment(ContentTabsStore.newInstance(), "BOOKS");
        adapter.addFragment(ContentTabsStore.newInstance(), "GAMES");
