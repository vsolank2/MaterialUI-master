...
public class ContentTabsGallery extends Fragment {

    public ContentTabsGallery() {
    }

    public static ContentTabsGallery newInstance() {
        ContentTabsGallery fragment = new ContentTabsGallery();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.content_tabs_gallery, container, false);
