...
public class ContentBottomSheetDialogFull extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = View.inflate(getContext(), R.layout.content_bottom_sheet_dialog_full, null);
